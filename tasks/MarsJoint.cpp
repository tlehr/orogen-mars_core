...
MarsJoint::MarsJoint(std::string const& name)
    : MarsJointBase(name)
{
}

MarsJoint::MarsJoint(std::string const& name, RTT::ExecutionEngine* engine)
    : MarsJointBase(name, engine)
{
}
...
bool MarsJoint::set_angle( double angle )
{
    target_pos = angle;
    return true;
}

double MarsJoint::get_angle()
{
    return motor_pos;
}

double MarsJoint::get_torque()
{
    return motor_torque;
}

bool MarsJoint::startHook()
{
    motor_pos = 0;
    motor_torque = 0;
    target_pos = 0;
...
void MarsJoint::updateHook()
{
    ...
    MarsJointBase::updateHook();
}
// void MarsJoint::errorHook()
// {
//     MarsJointBase::errorHook();
// }
void MarsJoint::stopHook()
{
    MarsJointBase::stopHook();
}
// void MarsJoint::cleanupHook()
// {
//     MarsJointBase::cleanupHook();
// }
    
void MarsJoint::update( double time )
{
...
//        theMotor->setMaximumVelocity( desired_velocity );
    ...
    motor_torque = theMotor->getTorque( );
}
